  ...
  return (
    <div className="bg-white">
      <HeroProgram
        ...
        sub="Data sudah ada, tapi bingung ngolahnya? Kami bantu dari analisis data, penulisan Bab 4-5, sampai kamu siap sidang akhir dan resmi ACC di depan dosen penguji."
        price="Rp 2.250.000"
