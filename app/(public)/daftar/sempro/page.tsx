...
import { Users, CheckCircle, Loader2, MessageCircle, Copy, Check, Tag, X } from 'lucide-react'
            ...
            {appliedCode ? (
              <>
                ...
                <div className="flex justify-between items-center pt-2 border-t border-gray-100">
                  ...
                  <p className="text-lg font-bold text-[#2232dd] flex-shrink-0">Rp {finalPrice.toLocaleString('id-ID')}</p>
                </div>
              ...
              <div className="flex justify-between items-center gap-3">
                ...
                <p className="text-lg font-bold text-[#2232dd] flex-shrink-0">Rp {BASE_PRICE.toLocaleString('id-ID')}</p>
              </div>
            )}
          </div>
