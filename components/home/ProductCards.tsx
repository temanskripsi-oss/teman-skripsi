...
const products = [
  {
    ...
    checkColor: '#16a34a',
    features: [
      'Video learning lengkap — tonton ulang kapan saja',
      'Zoom coaching mingguan bersama mentor',
      'Template proposal Bab 1, 2, 3 siap pakai',
  ...
  },
  {
    ...
    featured: true,
    features: [
      '6 pertemuan personal (3x offline + 3x online)',
