...
interface Props { accentColor?: string; embedded?: boolean }

function Content({ accentColor = '#2232dd' }: { accentColor?: string }) {
  return (
    <>
...
export default function MentorSection({ accentColor = '#2232dd', embedded = false }: Props) {
  if (embedded) return <Content accentColor={accentColor} />
  return (
